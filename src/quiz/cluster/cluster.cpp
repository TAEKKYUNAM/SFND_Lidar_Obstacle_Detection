...
void clusterHelper(std::vector<bool>& processed, int indice, const std::vector<std::vector<float>> points, std::vector<int>& cluster, KdTree* tree, float distanceTol)
{
	...
	{
		if(!processed[id])
			clusterHelper(processed, id, points,cluster, tree, distanceTol);
	}
}
...
std::vector<std::vector<int>> euclideanCluster(const std::vector<std::vector<float>>& points, KdTree* tree, float distanceTol)
{
	...
	while(i<points.size())
	{
		...
		clusterHelper(processed,i,points,cluster,tree,distanceTol);
